...
<div class="cookieContainer">
  <h2>AVISO LEGAL</h2>
  <p>
    Esta página Web es propiedad de IDEMO MOTORS, S.L. con NIF nº B64449051 y domicilio en POL. IND. CAN PETIT - CAMÍ FONT DE LES CANYES, 48 ( 08227 Terrassa ) e Inscrita en el Registro Mercantil de BARCELONA en el Tomo 39364 Libro FOLIO 0127  Inscripción 1 (o, alternativamente, registro especial o número de autorización)
  </p>
  <p>
    Para cualquier consulta o propuesta, contáctenos en el e-mail:<a href="XAVI@IDEMOMOTORS.COM">XAVI@IDEMOMOTORS.COM</a>
  </p>
  <p>
  ...
  <h5>Obligación de facilitarnos sus datos personales y consecuencias de no hacerlo.</h5>
  <p>
  ...
  <h4>3. DESTINATARIOS DE SUS DATOS.</h4>
  <p>
  ...
  <h4>5. DERECHOS EN RELACIÓN CON SUS DATOS PERSONALES.</h4>
  <p>
  ...
  <p><strong>Dónde y cómo solicitar sus Derechos:</strong></p>
  <p>
    Mediante un escrito dirigido al responsable a su dirección postal o electrónica (indicadas en el apartado A), indicando la referencia “Datos Personales”, especificando el derecho que se quiere ejercer y respecto a qué datos personales.
  </p>
  <p>
    En caso de divergencias con la empresa en relación con el tratamiento de sus datos, puede presentar una reclamación ante la Agencia de Protección de Datos (<a href="www.agpd.es">www.agpd.es</a>).
  </p>
  ...
  <h4>7. ACTUALIZACIÓN DE SUS DATOS</h4>
  <p>
  ...
  <p>
    La presente Política de Privacidad ha sido modificada en fecha _______ y puede ser modificada para adaptarlas a los cambios que se produzca en nuestra web, así como modificaciones legislativas o jurisprudenciales sobre datos personales que vayan apareciendo, por lo que exige su lectura, cada vez que nos facilite sus datos a través de esta Web.
  </p>
